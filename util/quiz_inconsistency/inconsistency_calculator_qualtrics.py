'''
    inconsistency_calculator_qualtrics.py
    Author: Liwei Jiang
    Date: 19/07/2018
    Usage: Check the number of inconsistent answer of the pre- and post- quizzes done via Qualtrics.
'''
import csv
import sys
import json

file_name_1 = "csv/QuizA.csv"
file_name_2 = "csv/QuizB.csv"
