...
file_name_1 = "QuizA.csv"
file_name_2 = "QuizB.csv"
...
quiz_a_repeated_index = [36, 54, 44, 8, 15, 57, 43, 13, 22, 33, 52, 17, 36, 47, 44, 4, 8, 6, 15, 24, 57, 43, 19]
quiz_b_repeated_index = [14, 19, 21, 30, 34, 40, 43, 0, 3, 4, 8, 9, 14, 20, 21, 59, 30, 32, 34, 37, 40, 43, 54]
...
for i in range(len(quiz_a)):
	quiz_a_data[quiz_a[i][17]] = quiz_a[i][21:-1]

for i in range(len(quiz_b)):
	quiz_b_data[quiz_b[i][17]] = quiz_b[i][21:-1]
