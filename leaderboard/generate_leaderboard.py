...
def generate(top_5_users, current_user, background_url = 'https://www.smartprimer.org:8443/pictures/leaderboard_background.png'):
    ...
    maxLen = max(5, len(top_5_users))
    names = [top_5_users[i][0]+' '+top_5_users[i][1] for i in range(maxLen)]
    ...
    for i in range(maxLen):
        body += '<div class="place1"><div class="top-rank">' + str(i+1) + '</div><div class="score">'+str(top_5_users[i][2])+'</div></div>'
